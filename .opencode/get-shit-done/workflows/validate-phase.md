...
```
Agent(
  prompt="Read /Users/kiryl/Projects/tt-bot/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/kiryl/Projects/tt-bot/.opencode/get-shit-done/templates/VALIDATION.md`
