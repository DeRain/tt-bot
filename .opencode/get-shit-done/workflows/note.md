...
- **Global scope**: `/Users/kiryl/Projects/tt-bot/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/kiryl/Projects/tt-bot/.opencode/notes/`)
...
2. Glob `/Users/kiryl/Projects/tt-bot/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/Users/kiryl/Projects/tt-bot/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/kiryl/Projects/tt-bot/.opencode/notes/` — works in any directory
