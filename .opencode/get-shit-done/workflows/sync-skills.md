...
INSTALL_JS_GLOBAL="/Users/kiryl/Projects/tt-bot/.opencode/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/kiryl/Projects/tt-bot/.opencode/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
