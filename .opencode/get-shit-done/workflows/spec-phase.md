...
```bash
INIT=$(node "/Users/kiryl/Projects/tt-bot/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/kiryl/Projects/tt-bot/.opencode/get-shit-done/templates/spec.md.
