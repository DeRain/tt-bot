...
```
Agent(
  prompt="Read /Users/kiryl/Projects/tt-bot/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/kiryl/Projects/tt-bot/.opencode/get-shit-done/templates/SECURITY.md`
